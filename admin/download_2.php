...
header('Content-Disposition: attachment; filename="hasil_psikotest_17aug.xls"');
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 </Styles><?php $rumuse= mysql_query("select * from Hasil where tanggal='2013-08-17'"); while ($while=mysql_fetch_array($rumuse)) { ?>
