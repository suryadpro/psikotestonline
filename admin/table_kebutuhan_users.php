...
if($pic == "") { $pics=""; } else { $pics=" and d.id_admin='$_SESSION[id]'"; }
...
<table border=1 width="99%" class="a">
	...
	a.client=b.id and d.region=c.id_region and a.pic=d.id_admin and a.bu=e.id_sbu and d.id_admin='$_SESSION[id]' $ids $bus $tgls $regs $clients order by a.id desc");while($row=mysql_fetch_Array($query)) { ?>
	<tr>
