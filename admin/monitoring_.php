...
<form action="menu.php?data=monitoring_&tanggal=on" method="POST" class="pure-form">
...
<form action="menu.php?data=monitoring_&proses=yes" method="POST" class="pure-form">
<br>
<hr>
<br>
...
<hr>
<br>
<form action="menu.php?data=monitoring_&label=yes" method="POST" class="pure-form">
...
<hr>
<br>
<form action="menu.php?data=monitoring_&bulan=yes" method="post" class="pure-form">			
			per Bulan :
