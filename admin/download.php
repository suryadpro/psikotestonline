...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Sheet1">
  <Table>
   ...
   </Row> <?php $query2=mysql_query("select * from register where user_name='$_GET[user_name]'"); $row3=mysql_fetch_array($query2); $query=mysql_query("select * from jawaban where user_name='$row3[user_id]' order by id asc"); $cek=mysql_num_rows($query); if ($cek == 0) { $query=mysql_query("select * from jawaban where user_name='$row3[user_id]' order by id asc"); } while($row=mysql_fetch_array($query)) { ?>
   <Row> 
