...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 </Styles><?php $rumuse= mysql_query("select * from register where kebutuhan='Customer Service' and user_name like'%@psd.balinus'"); while ($while=mysql_fetch_array($rumuse)) { 
 ?>
 <Worksheet ss:Name="<?php echo $while['nama_lengkap']; ?>">
  <Table>
