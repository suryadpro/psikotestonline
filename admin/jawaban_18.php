...
header('Content-Disposition: attachment; filename="hasil_psikotest_18aug.xls"');
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 </Styles><?php $rumuse= mysql_query("select * from Hasil where tanggal='2013-08-18'"); while ($while=mysql_fetch_array($rumuse)) { ?>
 <Worksheet ss:Name="<?php echo $while['user_name']; ?>">
  <Table>
   ...
   </Row> <?php $query=mysql_query("select * from jawaban where user_name='$while[user_name]'"); while($row=mysql_fetch_array($query)) { ?>
   <Row> 
    <Cell ss:StyleID="s62"><Data ss:Type="String"><?php echo $row['user_name']; ?></Data></Cell>
