...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 </Styles><?php $rumuse= mysql_query("select * from register where kebutuhan!='Marketing Communication' and kebutuhan!='cluster officer' and kebutuhan!='K3 Security' and user_name like'%@afrida'"); while ($while=mysql_fetch_array($rumuse)) { ?>
