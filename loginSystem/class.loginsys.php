...
class LoginSystem {
	...
	/* Start Config */
 	...
 	private $dbname = "table"; // Database Name
	...
	var $blockBruteForce	= true; // Deny login for $LS->bfTime seconds after incorrect login tries of 5
		...
		/* Extra Settings*/
			...
			private $staticPages  	= array(
				"/loginSystem/", "/loginSystem/reset.php"
			); // Pages that doesn't require logging in (exclude login page)
			
			private $loginPage    	= "/loginSystem/login.php"; // The login page. ex : /login.php or /accounts/login.php
			private $homePage     	= "/loginSystem/home.php"; // The home page. The main page for logged in users. Redirects to here when logs in
