...
{
$rumus=mysql_query("select * from Hasil where user_name='$user_name' AND tes4='ok'");
...
WHERE a.kode_soal=b.kode_soal and b.user_name='$user_name' AND b.jawaban='|||' ORDER BY $a");
$i=1;
...
<table border="0">
    <tr align="center">
        ...
        <td>
            <input type="radio" name="jawaban<?php echo $x; ?>"> <!-- <input type="checkbox" value="A"name="jawaban_a<?php echo $x; ?>" /> --><?php echo $row['jawaban_a'] ?>
        </td>
        <td> <!-- <input type="checkbox" value="B"name="jawaban_b<?php echo $x; ?>" /> --> <input type="radio" name="jawaban<?php echo $x; ?>"><?php echo $row['jawaban_b'] ?></td>
    </tr>
</table>
<hr />
<?php
