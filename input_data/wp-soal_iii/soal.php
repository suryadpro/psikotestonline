...
{
$query=mysql_query("select * from hasil where user_id='$id' AND tes3='ok'");
$cek=mysql_num_rows($query);
if($cek)
{
    ?> <br /><br /><script>alert('Anda sudah pernah melakukan psikotes di tahap  III. silahkan bepindah ke tahap IV');document.location.href="../wp-soal_iv/welcome.php";</script><?php
}
else
{
...
function checkboxlimit(checkgroup, limit){
	...
	<div class="form-2">
        <div class="login-header bordered">
            <h3><b>Tes 3 - Soal ( Berbatas Waktu )</b></h3>
        </div>
        <hr>
<h4 align="center"><b><font size="+1">Pada persoalan berikut akan diberikan deret angka. Setiap deret tersusun menurut suatu aturan tertentu dan dapat dilanjutkan menurut aturan itu.<br>
...
while($row=mysql_fetch_array($query)) { $no=$no+1; ?>
	...
	<tr height="40">
		<td><b><?php echo $no.".)"; ?> </td>
		<td><b><?php echo $row['soal_a']; ?></td>
		<td><b><?php echo $row['soal_b']; ?></td>
		<td><b><?php echo $row['soal_c']; ?></td>
		<td><b><?php echo $row['soal_d']; ?></td>
		<td><b><?php echo $row['soal_e']; ?></td>
		<td><b><?php echo $row['soal_f']; ?></td>
		<td><b><?php echo $row['soal_g']; ?></td>
		<td> <b> ? </b> </td>
	</tr>
	<tr>
		<td colspan="11"><hr></td>
...
checkboxlimit(document.forms.test.jwb<?php echo $no; ?>, 2)
