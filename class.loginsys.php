...
|   Support: http://subinsb.com/ask-logsys                              |
| ------------------------------------------------------------------------- |
...
class LoginSystem {
	...
	/* Start Config */
 	...
 	private $dbpass = "p3rs4d@20o9"; // MySQL Database Password
 	private $dbname = "psikotest_online2"; // Database Name
 	private $dbtable = "register"; // Your Users Table
 
 	private $secureKey    = "secureKey"; // A Secure Key For Cookie Encryption. Don't make this public
 	private $passwordSalt = "secureSalt"; // Secret Password Salt. Only change once before setting user registration public.
 	private $company      = "http://www.gmail.com"; // Company for name for including in emails
	...
	var $blockBruteForce	= true; // Deny login for $LS->bfTime seconds after incorrect login tries of 5
		...
		/* Extra Settings*/
			...
			private $staticPages  	= array(
				"/psikotest/", "/psikotest/reset.php"
			); // Pages that doesn't require logging in (exclude login page)
			
			private $loginPage    	= "/psikotest/index_.php"; // The login page. ex : /login.php or /accounts/login.php
			private $homePage     	= "/psikotest/home.php"; // The home page. The main page for logged in users. Redirects to here when logs in
